export default {
  ...
  FileDownloadedMessage: "O arquivo {filename} descargouse ({length})",
  FileDownloadeErrorMessage: "Error descargando o arquivo {filename}",
  Reload: "Recargar",
  ...
  "Auth session expired, requesting new...": "A sesión a expirou, vaise solicitar unha nova...",
  "Oooops": "¡Ups!",
};
