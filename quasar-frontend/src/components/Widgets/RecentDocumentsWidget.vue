...
<script setup lang="ts">
  ...
  import { type RecentDocumentsResponse, type RecentDocumentResponseItem } from "@/types/apiResponses";
  import { type RecentDocumentItem, RecentDocumentItemClass } from "@/types/recentDocumentItem";
