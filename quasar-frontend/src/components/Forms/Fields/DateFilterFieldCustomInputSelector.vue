...
<script setup lang="ts">
  ...
  import { type DateFilterClass } from "@/types/dateFilters";
  import { selectorAvailableOptions, type SelectorOption as SelectorOptionInterface } from "@/types/dateFilters";
