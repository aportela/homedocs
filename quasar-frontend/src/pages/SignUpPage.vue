    ...
    <q-card class="q-pa-xl" flat>
      <form @submit.prevent.stop="onValidateForm" autocorrect="off" autocapitalize="off" autocomplete="off"
        ...
        <q-card-section>
          ...
          <CustomInputPassword dense outlined ref="passwordRef" class="q-mt-md" v-model="profile.password"
        ...
        <q-card-section>
          ...
          <CustomBanner v-else-if="userCreatedSuccessfully" text="Your account has been created" success
            class="q-mt-lg">
