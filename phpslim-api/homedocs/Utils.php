...
class Utils
{
    ...
    public static function getMaxUploadFileSize(): float
    {
        ...
        if ($max_size < 0) {
            ...
            if (is_string($iniPostMaxSize)) {
                $post_max_size = self::parseIniSize($iniPostMaxSize);
                if ($post_max_size > 0) {
            ...
            $iniUploadMaxSize = ini_get('upload_max_filesize');
            if (is_string($iniUploadMaxSize)) {
                $upload_max = self::parseIniSize($iniUploadMaxSize);
